...
const EmployeeClearanceController ={
    EmployeeClearance: function(req,res){

        EmployeeClearanceData = [
            {
        ...
        res.render("pages/EmployeeClearancePage", {
            EmployeeClearanceData:EmployeeClearanceData
...
module.exports = EmployeeClearanceController;